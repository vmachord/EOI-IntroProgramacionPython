...
try:
    color=input('Entre el color para saber su posicion:')
    print("Posicion del color en la lista ",colores.index(color) )
except ValueError:
    print('el color no esta en la lista')

colores.remove('Yellow') #Error de ValueError si el elemento no esta en la lista
